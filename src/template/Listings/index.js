...
export const TopList = () => (
    <div>
        ...
        <div className="flex flex-wrap w-full justify-between">
            {Listings.map((list) => (
                <ListCard houseImage={list.image} title={list.title} address={list.address} parkSpace={list.parkSpace} price={list.price} ownerImage={list.owner_img} ownerName={list.owner_name} bathub={list.bathub} meter={list.meter} />
            ))}
        </div>
    </div>
);
