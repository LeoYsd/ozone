    ...
    return (
        <AuthLayout>
            ...
            <div className="text-center w-full flex justify-center my-8">
                    ...
                    You are about to confirm payment for this property, <span className="text-purple"> PropertyMe</span > holds your money in an Escrow account until the inspection is done so as to protect both parties.
                    </p>
            </div>
